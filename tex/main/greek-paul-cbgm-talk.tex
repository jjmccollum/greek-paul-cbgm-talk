...
\begin{document}
	...
	\end{frame}
	\begin{frame}
		\onslide<2->{\hfill\includegraphics[scale=0.2]{../img/adam.png}}
		\begin{itemize}
	...
	\begin{frame}
		...
		\end{itemize}
		\onslide<2->{\centering\includegraphics[scale=0.2]{../img/adam.png}}
	\end{frame}
	\section*{Roadmap}
	\begin{frame}
		\begin{itemize}
		...
		\begin{columns}
			...
			\begin{column}{0.45\textwidth}
				\begin{overlayarea}{\textwidth}{0.5\textheight}
					...
					\only<2>{
						\centering
						\includegraphics[width=0.75\textwidth]{../img/holy-grail.jpg}
	...
	\begin{frame}
		\begin{itemize}
			...
			\begin{center}
				...
				\hfill
				\raisebox{0.2\textheight}{\includegraphics[scale=0.3333]{../img/partial-global-stemma.pdf}}
			\end{center}
		\end{itemize}
	\end{frame}
